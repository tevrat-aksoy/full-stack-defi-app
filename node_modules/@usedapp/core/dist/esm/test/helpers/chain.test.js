...
describe('Chain helpers', () => {
    ...
    it('getExplorerAddressLink', () => {
        ...
        expect(getExplorerAddressLink(address, ChainId.Mainnet)).to.eq('https://etherscan.io/address/0xC7095A52C403ee3625Ce8B9ae8e2e46083b81987');
        expect(getExplorerAddressLink(address, ChainId.Ropsten)).to.eq('https://ropsten.etherscan.io/address/0xC7095A52C403ee3625Ce8B9ae8e2e46083b81987');
        expect(getExplorerAddressLink(address, ChainId.Kovan)).to.eq('https://kovan.etherscan.io/address/0xC7095A52C403ee3625Ce8B9ae8e2e46083b81987');
        ...
        expect(getExplorerAddressLink(address, ChainId.Theta)).to.eq('https://explorer.thetatoken.org/address/0xC7095A52C403ee3625Ce8B9ae8e2e46083b81987');
        expect(getExplorerAddressLink(address, ChainId.ThetaTestnet)).to.eq('https://testnet-explorer.thetatoken.org/address/0xC7095A52C403ee3625Ce8B9ae8e2e46083b81987');
        expect(getExplorerAddressLink(address, ChainId.Harmony)).to.eq('https://explorer.harmony.one/address/0xC7095A52C403ee3625Ce8B9ae8e2e46083b81987');
    ...
    it('getExplorerTransactionLink', () => {
        ...
        expect(getExplorerTransactionLink(tx, ChainId.Mainnet)).to.eq('https://etherscan.io/tx/0x5d53558791c9346d644d077354420f9a93600acf54eb6a279f12b43025392c3a');
        expect(getExplorerTransactionLink(tx, ChainId.Ropsten)).to.eq('https://ropsten.etherscan.io/tx/0x5d53558791c9346d644d077354420f9a93600acf54eb6a279f12b43025392c3a');
        expect(getExplorerTransactionLink(tx, ChainId.Kovan)).to.eq('https://kovan.etherscan.io/tx/0x5d53558791c9346d644d077354420f9a93600acf54eb6a279f12b43025392c3a');
        ...
        expect(getExplorerTransactionLink(tx, ChainId.Theta)).to.eq('https://explorer.thetatoken.org/tx/0x5d53558791c9346d644d077354420f9a93600acf54eb6a279f12b43025392c3a');
        expect(getExplorerTransactionLink(tx, ChainId.ThetaTestnet)).to.eq('https://testnet-explorer.thetatoken.org/tx/0x5d53558791c9346d644d077354420f9a93600acf54eb6a279f12b43025392c3a');
        expect(getExplorerTransactionLink(tx, ChainId.Harmony)).to.eq('https://explorer.harmony.one/tx/0x5d53558791c9346d644d077354420f9a93600acf54eb6a279f12b43025392c3a');
